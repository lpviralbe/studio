        ...
        <div className="container max-w-5xl mx-auto text-center animate-fade-in-up">
            ...
            <Card className="bg-card/50 backdrop-blur-sm border-white/10 text-left p-8">
              <CardContent className="p-0">
                <h3 className="text-2xl font-bold font-headline mb-4 text-center">{t('problemSolution.solutionTitle')}</h3>
                <p className="text-muted-foreground mb-8 text-lg text-center max-w-2xl mx-auto">{t('problemSolution.solutionDescription')}</p>
