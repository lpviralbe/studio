    ...
    <div className="w-full max-w-2xl mx-auto text-center p-8 bg-card/50 backdrop-blur-lg border border-primary/20 rounded-xl shadow-lg shadow-primary/10">
        ...
        <div className="mt-4 flex justify-center items-center gap-4">
            <Image
                ...
                width={120}
                height={40}
                className="h-auto animate-fade-in-up [animation-delay:300ms]"
            />
            <Image
                ...
                width={120}
                height={40}
                className="h-auto animate-fade-in-up [animation-delay:400ms]"
            />
            <Image
                ...
                width={120}
                height={40}
                className="h-auto animate-fade-in-up [animation-delay:500ms]"
            />
            <Image
                ...
                width={120}
                height={40}
                className="h-auto animate-fade-in-up [animation-delay:600ms]"
            />
        </div>
      </div>
  );
